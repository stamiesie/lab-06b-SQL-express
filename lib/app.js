...
app.post('/books', async (req, res) => {
  ...
  try {
    const data = await client.query(`INSERT INTO books (title, author, category, price, hardcover, shipping, owner_id)
...
app.put('/books/:id', async (req, res) => {
  try {
    ...
    SET title = $1, author = $2, category = $3, price = $4, hardcover = $5, shipping = $6
    WHERE id=$7
    returning *
    `,
      [
